...
function Form() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (mode === 'add') {
                // Add new company
                response = await axios.post('http://avo-adb-001.postgres.database.azure.com:5432/companies', formData);
            } else if (mode === 'edit') {
                // Update existing company
                response = await axios.put(`http://avo-adb-001.postgres.database.azure.com:5432/companies/${selectedCompanyId}`, formData);
            }
    ...
    const handleSelectChange = async (e) => {
        ...
        try {
            const response = await axios.get(`http://avo-adb-001.postgres.database.azure.com:5432/companies/${selectedCompany.id}`);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await axios.put(`http://avo-adb-001.postgres.database.azure.com:5432/companies/${selectedCompanyId}`, formData);
