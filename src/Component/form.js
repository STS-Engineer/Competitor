...
function Form() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (mode === 'add') {
                // Add new company
                response = await axios.post('https://avo-competitor-map.azurewebsites.net/companies', formData);
            } else if (mode === 'edit') {
                // Update existing company
                response = await axios.put(`https://avo-competitor-map.azurewebsites.net/companies/${selectedCompanyId}`, formData);
            }
    ...
    const handleSelectChange = async (e) => {
        ...
        try {
            const response = await axios.get(`https://avo-competitor-map.azurewebsites.net/companies/${selectedCompany.id}`);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await axios.put(`https://avo-competitor-map.azurewebsites.net/companies/${selectedCompanyId}`, formData);
